...
#define AI_FIRE_ORIGIN_MODEL_NAME   "cat_dog_dectection"
...
#define AI_FIRE_IN_SIZE_BYTES { \
  AI_FIRE_IN_1_SIZE_BYTES, \
}
#define AI_FIRE_IN_1_HEIGHT      (50)
#define AI_FIRE_IN_1_WIDTH       (50)
#define AI_FIRE_IN_1_CHANNEL     (3)
#define AI_FIRE_IN_1_SIZE        (50 *  50 *  3)
#define AI_FIRE_IN_1_SIZE_BYTES  (AI_FIRE_IN_1_SIZE * 4)
...
#define AI_FIRE_OUT_SIZE_BYTES { \
  AI_FIRE_OUT_1_SIZE_BYTES, \
}
#define AI_FIRE_OUT_1_CHANNEL     (1)
#define AI_FIRE_OUT_1_SIZE        (1)
#define AI_FIRE_OUT_1_SIZE_BYTES  (AI_FIRE_OUT_1_SIZE * 4)
